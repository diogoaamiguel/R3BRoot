...
R3BTofD::R3BTofD(const TString& geoFile,                    //R3BTofD::R3BTofD(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot)
                 DetectorId type,                           //: R3BTofD(geoFile, { trans, rot })
...
R3BTofD::R3BTofD(const TString& geoFile, DetectorId type, const TGeoCombiTrans& combi, const TString& namedetId)          // R3BTofD::R3BTofD(const TString& geoFile, const TGeoCombiTrans& combi)
    : R3BDetector(namedetId == "NULL" ? "R3BTofD" : "R3BTofD" + namedetId, type, geoFile, combi)                          //    : R3BDetector("R3BTofD", kTOFD, geoFile, combi)
